...
# ADVERTENCIA / WARNING
# =============================================================================
# Esta aplicación está diseñada como aplicación de escritorio, NO para su
# ejecución en un servidor en Internet. El uso de WSGI u otros servidores web
# no está soportado.
#
# This application is designed as a desktop application, NOT for running on
# an Internet server. The use of WSGI or other web servers is not supported.
#
# Si eres un usuario avanzado y sabes lo que estás haciendo, puedes comentar
# la siguiente línea para continuar bajo tu propia responsabilidad.
# If you are an advanced user and know what you are doing, you can comment
# out the following line to proceed at your own risk.
# =============================================================================
sys.exit(
    "ERROR: Esta aplicación es de escritorio, no está preparada para servidores. / This is a desktop application, not ready for servers."
)  # pylint: disable=C0301


# Set environment flag for WSGI
os.environ["RUNNING_UNDER_WSGI"] = "True" # pylint: disable=W0101
